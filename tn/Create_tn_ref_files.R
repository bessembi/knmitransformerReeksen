...
refData <- KnmiRefFile("KNMI14____ref_tn___19810101-20101231_v3.2.txt")  

# Copy the file here for the sake of completeness
file.copy(refData, "tn/KNMI14____ref_tn.txt", overwrite = TRUE)
...
fn <- function(scenario, horizon) {
  ...
  filename <- paste0(filename, "_tn.txt")
  TransformTemp(input = refData, var = "tn",
